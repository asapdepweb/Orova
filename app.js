...
// ============================================================
var allProducts = [
  { code: 'CAD-001',   name: 'Cadena 10k',          stock: 0, price: '',          img: '' },
  { code: 'CAD-002',   name: 'Cadena Cartier 10k',  stock: 0, price: '',          img: '' },
  { code: 'CAD-003',   name: 'Cadena Light 10k',    stock: 0, price: '',          img: '' },
  { code: 'CAD-004',   name: 'Cadena Pavé 10k',     stock: 1, price: '$3,920.00', img: 'img/productos/CAD-004.png' },
  { code: 'ARE-001',   name: 'Arete Brokel 10k',    stock: 2, price: '$355.00',   img: 'img/productos/ARE-001.png' },
  { code: 'ARE-002',   name: 'Arete Broquel 10k',   stock: 2, price: '$370.00',   img: 'img/productos/ARE-002' },
  { code: 'ARR-001',   name: 'Arracada Básica 10k', stock: 2, price: '$1,160.00', img: 'img/productos/ARR-001.jpg' },
  { code: 'PUL-001A',  name: 'Pulso 10k',           stock: 0, price: '',          img: '' },
  { code: 'PUL-001.2', name: 'Pulso 10k',           stock: 1, price: '$4,620.00', img: 'img/productos/PUL-001.2.jpg' },
...
var CATS = { CAD: 'Cadena', ARE: 'Aretes', ARR: 'Arracadas', PUL: 'Pulseras', HUG: 'Huggie' };
